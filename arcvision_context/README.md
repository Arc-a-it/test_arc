...
- Generated from commit: 7c1eeae8d5a5bf8ee5d0b660270501c8078b653c
- Generation timestamp: 2026-02-06T05:31:31.402Z
- Tool version: 0.2.24
...
- **blocked-legacy-monolith/src/emailService.js**
  - Blast Radius: 2 files (12.5% of codebase)
  - Risk: Changes here may silently propagate across the system.

- **blocked-legacy-monolith/src/paymentProcessor.js**
  - Blast Radius: 2 files (12.5% of codebase)
  - Risk: Acts as a coordination layer between components.

- **architecture-destroyer.js**
